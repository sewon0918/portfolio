...
export const Instruction = () => {
  return (
    <div>
      ...
      제공하는 데 집중했습니다. 웹 개발로 시작해 점차 웹뷰과 네이티브 앱
      개발까지 범위를 확장하며, 각 단계에서 발생한 기술적 도전을 해결했습니다.
      특히 지난 1년 반 동안 모든 클라이언트 부분을 혼자서 개발, 운영해왔고, 그
      과정에서 발생하는 문제들을 빠르게 파악하고 해결했습니다. <br />
      작고 빠른 스타트업의 초기 멤버로 함께하며 단순히 주어진 개발을 하는 것보다
      문제를 발견하고, 가설을 세우고 검증하는 것의 가치를 배웠습니다. 창의적으로
      해결책을 찾아내는 데 자신이 있으며, 새로운 기술을 배우고 발전하는 데
      열정을 가지고 있습니다. 효율적이고 직관적인 UI/UX를 구현하는 데 강점을
      가지고 있습니다.
    </div>
  );
};
