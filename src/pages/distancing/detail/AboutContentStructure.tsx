    ...
    <ProjectDetailTemplate
      ...
      description={{
        ...
        "세부 설계": [
          ...
          "모든 Cell 컴포넌트는 공통 기본 인터페이스(BaseCell)를 상속받도록 설계했습니다. 이 인터페이스는 id, value 등 모든 Cell이 공유해야 하는 최소한의 속성을 정의하고, 각 Cell 타입(TextCell, ImageCell, GraphCell 등)은 이 기본 인터페이스를 확장하여 자신만의 고유한 속성과 동작을 추가할 수 있도록 했습니다.",
