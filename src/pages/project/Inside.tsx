...
export default function Inside() {
  return (
    <ProjectTemplate
      ...
      description={{
        ABOUT: [
          "화상 상담 서비스입니다. 사용자는 자신의 니즈에 맞는 상담사를 찾아 상담을 예약하고, 예약된 시간에 화상 상담을 진행합니다.",
        ],
        ...
        "KEY FEATURES": [
          ...
          "온보딩 과정에서 몰입감 있는 사용자 경험을 위해 각 질문마다 페이지를 분리하지 않고, 스크롤되는 듯한 인터랙션을 구현했습니다. 이에 따라 스와이프 제스처를 통해 이전 질문으로 이동하는 기능을 구현하여 모바일 사용자 경험을 개선했습니다. ",
        ],
      }}
    ></ProjectTemplate>
  );
