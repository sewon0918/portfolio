...
export default function Anxy() {
  return (
    <ProjectTemplate
      ...
      description={{
        ABOUT: [
          "불안 관리 솔루션입니다. 사용자는 불안에 대해 배우고, 자신의 불안을 기록하고 회고하며 불안을 다스리는 방법을 배웁니다. 함께하는 서로를 응원합니다.",
        ...
        "KEY FEATURES": [
          ...
          `이후 식이장애 관리 솔루션 Betty, 수면 관리 솔루션 Somny, 우울 관리 솔루션 Loomy 에서도 동일한 설계를 활용했고, monorepo 구조를 도입하여 코드베이스를 효율적으로 관리할 수 있도록 했습니다.`,
        ],
      }}
      appStoreLink={
